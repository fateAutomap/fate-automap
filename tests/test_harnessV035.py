...
def main():
    ...
    try:
        ...
        # DIFF (module-based)
        try:
            if modules_cfg and isinstance(modules_cfg, dict) and ("old" in modules_cfg and "new" in modules_cfg):
                _, f_old, _, f_new = modules
                old_code = inspect.getsource(f_old)
                new_code = inspect.getsource(f_new)
        ...
        results_file = "testsV035.results"
