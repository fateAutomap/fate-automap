...
External automap tool for Fate – Gates of Dawn (Amiga)

--------------------------------------------------

Overview

Fate Automap connects to a running emulator and reads memory in real time.
...
- Debug tools
- F12 quick return to emulator

--------------------------------------------------

New in This Version

- Stable encounter index across F2 and F3
- F3 now displays: [index](x,y)
- Enables matching encounter composition to map position
...
- Click window for keyboard focus
